...
3. Вносим свои изменения или предлагаем доработкии делаем коммит об этом.
...
Бывает так, что полсле успешного `push`-а поле с кнопкой **Compare & pull request** не появляется на странице вашего Fork-а. Тогда необходимо нажать:

![Pullreq](pullreq.jpg)

и оформить свой **Pull request**.

Когда ваши правки/изменения были приняты или вы просто хотите обновить свой **Fork** до посленей версии, то на странице конкретного **Fork**-а в списке виших репозиториев необходимо нажать: 
